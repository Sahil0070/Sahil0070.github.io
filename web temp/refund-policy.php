...
<!-- Mirrored from zairito-html.zainiktheme.com/demo/refund-policy.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jan 2022 16:59:41 GMT -->
<head>
        <meta charset="UTF-8" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <title>Refund Policy - Zairito - eCommerce HTML Template</title>
            ...
            <div class="container">
                <div class="breadcrumb-wrap text-center">
                    ...
                    <ul class="breadcrumb-pages">
                        ...
                        <li class="page-item">Refund policy</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="page-menu-wrap">
                            <ul class="menu-items">
                                ...
                                <li class="menu-item"><a class="menu-link" href="faq.html"><i class="menu-icon far fa-file-alt"></i>faq</a></li>
                                <li class="menu-item active"><a class="menu-link" href="refund-policy.html"><i class="menu-icon far fa-file-alt"></i>Refund Policy</a></li>
                            </ul>
                        </div>
                    </div>
