...
<!-- Mirrored from zairito-html.zainiktheme.com/demo/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jan 2022 16:59:41 GMT -->
<head>
        <meta charset="UTF-8" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <title>About us - Zairito - eCommerce HTML Template</title>
            ...
            <div class="header-bottom">
                <nav class="menu-area">
                    <ul class="main-menu">
                        ...
                        <li class="menu-item active"><a class="menu-link" href="about-us.html">about us</a></li>
                        <li class="menu-item menu-item-has-children">
                ...
                <div class="row align-items-lg-center">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="about-us-content">
                            ...
                            <p class="about-us-text">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere consectetur sed, convallis at tellus. Donec rutrum congue leo eget malesuada. Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Vestibulum ac diam sit amet quam vehicula elementum sed sit amet </p>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="single-service">
                                        ...
                                        <div class="service-info">
                                            ...
                                            <p class="service-content">We believe getting dressed should be the easiest part of your day.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-10 offset-lg-1">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-features text-center">
                                    <div class="features-icon">
                                        <img src="assets/images/features-icon-1.png" alt="features-icon" />
                                    </div>
                                    <h3 class="features-title">Men's collection</h3>
                                    <p class="features-content">We believe getting dressed should be the easiest part of your day.</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-features text-center">
                                    <div class="features-icon">
                                        <img src="assets/images/features-icon-2.png" alt="features-icon" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-features text-center">
                                    <div class="features-icon">
                                        <img src="assets/images/features-icon-3.png" alt="features-icon" />
                                    </div>
...
<!-- Mirrored from zairito-html.zainiktheme.com/demo/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jan 2022 16:59:47 GMT -->
</html>