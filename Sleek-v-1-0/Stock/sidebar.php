    ...
    <div class="sidebar-scrollbar">
      ...
      <ul class="nav sidebar-inner" id="sidebar-menu">
        ...
        <li class="has-sub expand">
          <a class="sidenav-item-link" href="../mylogin.php" data-toggle="collapse" data-target="#dashboard" aria-expanded="false" aria-controls="dashboard">
            <i class="mdi mdi-view-dashboard-outline"></i>
        ...
        <li class="has-sub">
          <a class="sidenav-item-link" href="Sub-category/index.php" target="_blank" data-toggle="collapse" data-target="#charts" aria-expanded="true" aria-controls="charts">
            ...
            <!-- <div class="sub-menu">
              ...
              <li class="has-sub">
                <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#authentication" aria-expanded="false" aria-controls="authentication">
                  <span class="nav-text">Order Master</span>
                </a>
        ...
        <li class="has-sub">
          <a class="sidenav-item-link" href="Sub-category/index.php" target="_blank" data-toggle="collapse" data-target="#documentation" aria-expanded="false" aria-controls="documentation">
