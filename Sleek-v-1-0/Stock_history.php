            ...
            <div class="body">
                <div class="container">
                    <div class="alert alert alert-primary" role="alert">
                        <h4 class="text-primary text-center">Stock history</h4>
                    </div>
                    <?php
                    include_once 'Stock history/form.php';
                    include_once 'Stock history/profile.php';
                    ?>
                    ...
                    <?php
                    include_once 'Stock history/stock_table.php';
                    ?>
                    <nav id="pagination">
                ...
                <div>
                    ...
                    <script src="Stock history/js/script.js"></script>
