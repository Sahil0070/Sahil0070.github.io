...
?>
  ...
  <head>
    ...
    <link rel="stylesheet" href="Sub-category/css/style.css">
      ...
      <div class="page-wrapper">
        ...
        <div class="body">
          <div class="container">
            ...
            <?php
            include_once 'Sub-category/form.php';
            include_once 'Sub-category/profile.php';
            ?>
            ...
            <?php
            include_once 'Sub-category/Sub_category_table.php';
            ?>
            <nav id="pagination">
          ...
          <div>
            ...
            <script src="Sub-category/js/script.js"></script>
